...
class AppLocalizationsBg extends AppLocalizations {
  ...
  @override
  String get welcomeMessage => 'Здравей, приключенецо! Какво ще правим днес?';

  @override
  String get taskCompleted => 'Задачата е изпълнена!';

  @override
  String xpGained(int xp) {
    return 'Спечелихте $xp точки опит';
  }

  @override
  String levelUp(int level) {
    return 'Достигнахте ниво $level!';
  }

  @override
  String get categoryMedical => 'Медицински преглед';

  @override
  String get categoryHabit => 'Ежедневен навик';

  @override
  String get categoryEvent => 'Специално събитие';

  @override
  String get noTasks => 'Тук е тихо... Изпийте чай или добавете задача.';
  ...
  @override
  String get statsProgress => 'Напредък на нивото';
