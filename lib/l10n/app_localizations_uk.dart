...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get welcomeMessage =>
      'Привіт, шукачу пригод! Що будемо робити сьогодні?';
  ...
  String xpGained(int xp) {
    return 'Ви заробили $xp очок досвіду';
  }

  @override
  String levelUp(int level) {
    return 'Ви досягли рівня $level!';
  }

  @override
  String get categoryMedical => 'Медичний запис';

  @override
  String get categoryHabit => 'Щоденна звичка';

  @override
  String get categoryEvent => 'Особлива подія';

  @override
  String get noTasks => 'Тут тихо... Випийте чаю або додайте завдання.';
  ...
  @override
  String get statsProgress => 'Прогрес рівня';
